...
Wolf, P.P. de (2002). *HiTaS: a heuristic approach to cell suppression\index{cell suppression} in hierarchical tables.* Proceedings of the AMRADS meeting in Luxembourg.
